...
2. Execute the scripts from `EFCore.TableValuedFunctions/Sql_Scripts/Table_Valued_Functions.sql`

## Configuration

Update the connection string in `EFCore.TableValuedFunctions/Database/AdventureWorks2019DB.cs` if needed:
